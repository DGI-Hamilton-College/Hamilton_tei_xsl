  ...
  <xsl:template match="tei:surname">
    ...
    <xsl:choose>
      <xsl:when test="descendant::tei:reg"> (<a>
          ...
          <xsl:attribute name="href"><xsl:value-of select="concat($SEARCHURL, 'tei.surname%3A%22')"></xsl:value-of><xsl:value-of select="descendant::tei:reg"></xsl:value-of>%22/-</xsl:attribute>
          <xsl:value-of select="descendant::tei:reg"></xsl:value-of>
        </a>) </xsl:when>
      <xsl:when test="descendant::tei:corr"> (<a>
          <xsl:attribute name="class">search persName</xsl:attribute>
          <xsl:attribute name="target">_blank</xsl:attribute>
          <xsl:attribute name="href"><xsl:value-of select="concat($SEARCHURL, 'tei.surname%3A%22')"></xsl:value-of><xsl:value-of select="descendant::tei:corr"></xsl:value-of>%22/-</xsl:attribute>
          <xsl:value-of select="descendant::tei:corr"></xsl:value-of>
        </a>) </xsl:when>
      <xsl:when test="descendant::expan"> (<a>
          <xsl:attribute name="class">search persName</xsl:attribute>
          <xsl:attribute name="target">_blank</xsl:attribute>
          <xsl:attribute name="href"><xsl:value-of select="concat($SEARCHURL, 'tei.surname%3A%22')"></xsl:value-of><xsl:value-of select="descendant::tei:expan"></xsl:value-of>%22/-</xsl:attribute>
          <xsl:value-of select="descendant::tei:expan"></xsl:value-of>
        </a>) </xsl:when>
      <xsl:otherwise> (<a>
          <xsl:attribute name="class">search persName</xsl:attribute>
          <xsl:attribute name="target">_blank</xsl:attribute>
          <xsl:attribute name="href"><xsl:value-of select="concat($SEARCHURL, 'tei.surname%3A%22')"></xsl:value-of><xsl:value-of select="."></xsl:value-of>%22/-</xsl:attribute>
          <xsl:value-of select="."></xsl:value-of>
        </a>) </xsl:otherwise>
    </xsl:choose>
  </xsl:template>
...
(<a>
          ...
          <xsl:attribute name="target">_blank</xsl:attribute>
          <xsl:attribute name="href"><xsl:value-of select="concat($SEARCHURL, 'tei.placeName%3A%22')"></xsl:value-of><xsl:value-of select="descendant::tei:choice/tei:reg"></xsl:value-of>%22/-</xsl:attribute>
          <xsl:value-of select="descendant::tei:reg"></xsl:value-of>
        </a>)
      </xsl:when>
...
(<a>
          <xsl:attribute name="class">search placeName</xsl:attribute>
          <xsl:attribute name="target">_blank</xsl:attribute>
          <xsl:attribute name="href"><xsl:value-of select="concat($SEARCHURL, 'tei.placeName%3A%22')"></xsl:value-of><xsl:value-of select="descendant::tei:corr"></xsl:value-of>%22/-</xsl:attribute>
          <xsl:value-of select="descendant::tei:corr"></xsl:value-of>
        </a>)
      </xsl:when>
...
(<a>
          <xsl:attribute name="class">search placeName</xsl:attribute>
          <xsl:attribute name="target">_blank</xsl:attribute>
          <xsl:attribute name="href"><xsl:value-of select="concat($SEARCHURL, 'tei.placeName%3A%22')"></xsl:value-of><xsl:value-of select="descendant::tei:expan"></xsl:value-of>%22/-</xsl:attribute>
          <xsl:value-of select="descendant::tei:expan"></xsl:value-of>
        </a>)
      </xsl:when>
      <xsl:otherwise>
(<a>
          <xsl:attribute name="class">search placeName</xsl:attribute>
          <xsl:attribute name="target">_blank</xsl:attribute>
          <xsl:attribute name="href"><xsl:value-of select="concat($SEARCHURL, 'tei.placeName%3A%22')"></xsl:value-of><xsl:value-of select="."></xsl:value-of>%22/-</xsl:attribute>
          <xsl:value-of select="."></xsl:value-of>
        </a>)
</xsl:otherwise>
    </xsl:choose>
...
(<a>
          ...
          <xsl:attribute name="target">_blank</xsl:attribute>
          <xsl:attribute name="href"><xsl:value-of select="concat($SEARCHURL, 'tei.orgName%3A%22')"></xsl:value-of><xsl:value-of select="descendant::tei:choice/tei:reg"></xsl:value-of>%22/-</xsl:attribute>
          <xsl:value-of select="descendant::tei:reg"></xsl:value-of>
        </a>)
      </xsl:when>
      <xsl:when test="descendant::tei:corr">
(<a>
          <xsl:attribute name="class">search orgName</xsl:attribute>
          <xsl:attribute name="target">_blank</xsl:attribute>
          <xsl:attribute name="href"><xsl:value-of select="concat($SEARCHURL, 'tei.orgName%3A%22')"></xsl:value-of><xsl:value-of select="descendant::tei:corr"></xsl:value-of>%22/-</xsl:attribute>
          <xsl:value-of select="descendant::tei:corr"></xsl:value-of>
        </a>)
      </xsl:when>
      <xsl:when test="descendant::tei:expan">
(<a>
          <xsl:attribute name="class">search orgName</xsl:attribute>
          <xsl:attribute name="target">_blank</xsl:attribute>
          <xsl:attribute name="href"><xsl:value-of select="concat($SEARCHURL, 'tei.orgName%3A%22')"></xsl:value-of><xsl:value-of select="descendant::tei:expan"></xsl:value-of>%22/-</xsl:attribute>
          <xsl:value-of select="descendant::tei:expan"></xsl:value-of>
        </a>)
      </xsl:when>
      <xsl:otherwise>
(<a>
          <xsl:attribute name="class">search orgName</xsl:attribute>
          <xsl:attribute name="target">_blank</xsl:attribute>
          <xsl:attribute name="href"><xsl:value-of select="concat($SEARCHURL, 'tei.orgName%3A%22')"></xsl:value-of><xsl:value-of select="."></xsl:value-of>%22/-</xsl:attribute>
          <xsl:value-of select="."></xsl:value-of>
        </a>)
</xsl:otherwise>
    </xsl:choose>
